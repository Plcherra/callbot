    ...
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <Card className="mt-8">
        ...
        <CardContent className="prose prose-sm max-w-none space-y-4 text-sm">
          ...
          <p>
            We use <strong>Telnyx</strong> for phone numbers, <strong>Deepgram, ElevenLabs, and Grok</strong> for voice AI, <strong>Supabase</strong> for secure data, and <strong>Stripe</strong> for payments. Your data is encrypted and never sold to third parties.
          </p>
