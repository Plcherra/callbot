...
import { AddReceptionistWizardModal } from "@/app/components/receptionists/AddReceptionistWizardModal";
          ...
          {currentStep === 2 && (
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Each receptionist gets a dedicated phone number. Click below to open the setup wizard.
                </p>
              </div>
